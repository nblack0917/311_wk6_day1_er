...
The actor Primary Key of actor_id can relate to many of the film_actor actor_id coloumns allowing an actor to be listed in multiple film_actor roles.

2. What does the blue diamond next to the "last_update" column on the "inventory" table represent?

NOT NULL simple attribute. It is a timestamp of the last update to this actor_id.

3. How many foreign keys does the "payments" table have? How can you tell?

The Red filled and not filled Diamonds indicate there are 3 foreign keys.
